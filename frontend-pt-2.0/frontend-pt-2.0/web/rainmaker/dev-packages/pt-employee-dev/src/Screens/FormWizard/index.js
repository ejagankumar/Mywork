  ...
  renderStepperContent = (selected, fromReviewPage) => {
    ...
    switch (selected) {
      ...
      case 4:
        ...
        return (
          <div>
            <AcknowledgementCard acknowledgeType='success' receiptHeader="PT_ASSESSMENT_NO" messageHeader={this.getMessageHeader()} message={this.getMessage()} receiptNo={assessedPropertyDetails['Properties'][0]['acknowldgementNumber']} />
          </div>
        );
      case 5:
