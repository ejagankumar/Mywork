  ...
  return (
    <div>
      <div key={1} style={{ marginBottom: "50px" }} className=" col-md-12 col-lg-12">
        ...
        <AcknowledgementCard acknowledgeType='success' receiptHeader="PT_PMT_RCPT_NO" messageHeader='PT_PROPERTY_PAYMENT_SUCCESS' message='PT_PROPERTY_PAYMENT_NOTIFICATION' receiptNo={ReceiptNo} />
        {/* <AcknowledgementCard acknowledgeType='success'  messageHeader='' message='' receiptHeader='PT_APPLICATION_NO_LABEL' receiptNo=''/> */}
      </div>
      <ActionFooter key={2} label2='PT_DOWNLOAD_RECEIPT' secondaryAction={primaryAction} label1='PT_ASSESS_PAY_FOR_NEW_YEAR' primaryAction={() => {
              generateReceipt("pt-reciept-citizen", receiptDetails, generalMDMSDataById, receiptImageUrl);
            }} />
    </div>
  );
